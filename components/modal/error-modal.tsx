    ...
    return (
        isShow && (
            <BaseModal onClick={() => setIsShow(false)}>
                <div className="absolute left-1/2 top-1/2 flex w-full max-w-xs -translate-x-1/2 -translate-y-1/2 flex-col items-center rounded-2xl bg-neutral-700">
                    <div className="flex w-full items-center justify-between rounded-t-2xl bg-red-400 px-4 py-3">
                        ...
                        <CircleX className="cursor-pointer text-xl" onClick={() => setIsShow(false)} />
                    </div>
